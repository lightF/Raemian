...
<body>
	<nav>
		<div class="menusize">
			<ul id="menus">
				...
				<li class="topmenu2"><a href="/config_main.jsp">관리자현황</a></li>관리자현황
				</li>
	...
	<main class="page_main">
		<section class="page_section">
			<form id="frm" name="frm" method="post" action="/notice/list">
				<div class="listbody">
						...
						<section class="data_listsview">
							<div class="protaball">
								<table width="1100">
									...
									<c:forEach items="${nt}" var="list">
										<ul>
											<li>${nt.getCno()}</li>gety
											<li style="text-align: left; justify-content: flex-start;"
												onclick="linked(${notice.getCno()})">
												${notice.getCtitle()}</li>
											<c:if test="${notice.getCfiledir()!=null}">
												<li>O</li>
											</c:if>
											<c:if test="${notice.getCfiledir()==null}">
												<li>X</li>
											...
											<li><input type="button" value="삭제" class="delbtn"
												onclick="deleteNotice(${notice.getCno()})"></li>
										</ul>
									</c:forEach>
									<!-- 결과를 표시할 영역 시작-->
							...
							<span class="notice_btns"> <input type="button"
								value="글쓰기" class="meno_btn2"></span>
							<aside>
